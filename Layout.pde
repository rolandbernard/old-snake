...
class layout
{
  ...
  layout(String path)
  {
    ...
    m_layoutArray = new layoutArray[sizeList[9]];
    ...
    for(int i = 0; i < sizeList[0]; i++)
    {
      ...
      m_button[i] = new button( int(aList[0])/10000f, int(aList[1])/10000f, int(aList[2])/10000f, int(aList[3])/10000f, int(aList[4])/10000f, aList[5] , m_color);
      loading++;
    }
    index += sizeList[0];
    ...
    for(int i = 0; i < sizeList[1]; i++)
    {
      ...
      m_checkbox[i] = new checkBox( int(aList[0])/10000f, int(aList[1])/10000f, int(aList[2])/10000f, int(aList[3])/10000f, boolean( int(aList[4]) ), m_color);
      loading++;
    }
    index += sizeList[1];
    ...
    for(int i = 0; i < sizeList[2]; i++)
    {
      ...
      m_slider[i] = new slider( int(aList[0])/10000f, int(aList[1])/10000f, int(aList[2])/10000f, int(aList[3])/10000f, int(aList[4])/10000f, int(aList[5]), int(aList[6]) , m_color);
      loading++;
    }
    index += sizeList[2];
    ...
    for(int i = 0; i < sizeList[3]; i++)
    {
      ...
      m_picture[i] = new picture(aList[0], int(aList[1])/10000f, int(aList[2])/10000f, int(aList[3])/10000f, int(aList[4])/10000f, int(aList[5]));
      loading++;
    }
    index += sizeList[3];
    ...
    for(int i = 0; i < sizeList[4]; i++)
    {
      ...
      m_svg[i] = new svg(aList[0], int(aList[1])/10000f, int(aList[2])/10000f, int(aList[3])/10000f, int(aList[4])/10000f, int(aList[5]));
      loading++;
    }
    index += sizeList[4];
    ...
    for(int i = 0; i < sizeList[5]; i++)
    {
      ...
      m_text[i] = new text(int(aList[0])/10000f, int(aList[1])/10000f, int(aList[2])/10000f, aList[3], int(aList[4]), int(aList[5]), m_color);
      loading++;
    }
    index += sizeList[5];
    ...
    for(int i = 0; i < sizeList[6]; i++)
    {
      ...
      rectData[i][0] = int(aList[0])/10000f;
      rectData[i][1] = int(aList[1])/10000f;
      rectData[i][2] = int(aList[2])/10000f;
      rectData[i][3] = int(aList[3])/10000f;
    ...
    for(int i = 0; i < sizeList[7]; i++)
    {
      ...
      m_svgButton[i] = new svgButton( aList[0], int(aList[1])/10000f, int(aList[2])/10000f, int(aList[3])/10000f, int(aList[4])/10000f, int(aList[5]), m_color);
      loading++;          
    }
    index += sizeList[7];
    ...
    for(int i = 0; i < sizeList[8]; i++)
    {
      ...
      m_selection[i] = new selection(int(aList[0])/10000f, int(aList[1])/10000f, int(aList[2])/10000f, int(aList[3])/10000f, oList, int(aList[5])/10000f, m_color);
      loading++;        
    }
    index += sizeList[8];
    
    for(int i = 0; i < sizeList[9]; i++)
    {
      buffer = obj.get(index+i);
      String aList[] = split(buffer,"|");
      
      color m_color[] = {color( int(aList[5]), int(aList[6]), int(aList[7])), color( int(aList[8]), int(aList[9]), int(aList[10]))};
      m_layoutArray[i] = new layoutArray(aList[0], int(aList[1])/10000f, int(aList[2])/10000f, int(aList[3])/10000f,  int(aList[4])/10000f, m_color);
      loading++;   
    }
    index += sizeList[9];
